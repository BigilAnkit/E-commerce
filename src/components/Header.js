...
const Header = () => (
  <header className='h-16 shadow-sm bg-white'>
    <div className=' h-full container mx-auto flex items-center px-4 justify-between'>
      <div className=''>
        <Link to={"/"}>
          {/* props passing width and height */}
        <Logo w={90} h={50} />
        </Link>
      </div>

      <div className='hidden lg:flex flex items-center w-full justify-between max-w-sm border rounded-full focus-within:shadow pl-2'>
